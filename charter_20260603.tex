...
4	   & Se completa hasta el punto 15 inclusive.       & 29 de mayo de 2026 \\ \hline
5	   & Se corrige el punto 10 (AoN).       & 3 de junio de 2026 \\ \hline
...
\begin{itemize}
    ...
    \item \textbf{Obtención y preprocesamiento de datos (130 h)}
    \begin{itemize}
        ...
        \item Definición y etiquetado de la variable objetivo (\textit{target}): atraso mayor a 90 días en la ventana de desempeño de 12 meses (20 h).
        \item Limpieza exhaustiva de la muestra, tratamiento de valores nulos y filtrado de \textit{outliers} (30 h).
    \end{itemize}

    \item \textbf{Desarrollo algorítmico y evaluación (220 h)}
    \begin{itemize}
        \item Análisis exploratorio de datos (EDA) y cálculo de la divergencia de distribuciones (40 h).
...
2  & Exploraci\'on diccionarios BCRA y bur\'o privado & 1/05/26  & 12/05/26 & 12 & 40 & 1    \\ \hline
3  & Formulaci\'on metodol\'ogica y umbrales KS       & 13/05/26 & 22/05/26 & 10 & 40 & 0;2  \\ \hline
4  & Validaci\'on propuesta con Sector de Finanzas      & 25/05/26 & 1/06/26  & 8  & 30 & 3    \\ \hline
5  & Extracci\'on ventana hist\'orica 60 meses        & 2/06/26  & 11/06/26 & 10 & 40 & 4    \\ \hline
6  & Integraci\'on datos BCRA y bur\'o privado        & 12/06/26 & 23/06/26 & 12 & 40 & 5    \\ \hline
7  & Definici\'on y etiquetado del target ($>$90 d\'ias) & 12/06/26 & 19/06/26 & 8 & 20 & 5 \\ \hline
8  & Limpieza, nulos y filtrado de outliers               & 24/06/26 & 1/07/26  & 8  & 30 & 6;7  \\ \hline
9  & EDA y divergencia de distribuciones                  & 2/07/26  & 9/07/26  & 8  & 40 & 8    \\ \hline
10 & Feature engineering y selecci\'on de variables     & 10/07/26 & 21/07/26 & 12 & 40 & 9    \\ \hline
11 & Entrenamiento modelo base y enriquecido              & 22/07/26 & 31/07/26 & 10 & 40 & 10   \\ \hline
12 & C\'alculo PSI y feature importance                 & 3/08/26  & 10/08/26 & 8  & 30 & 11   \\ \hline
13 & An\'alisis comparativo KS por deciles              & 11/08/26 & 20/08/26 & 10 & 40 & 12   \\ \hline
14 & Pipeline batch y estimaci\'on swap-in              & 21/08/26 & 28/08/26 & 8  & 30 & 13   \\ \hline
15 & Redacci\'on memoria t\'ecnica                    & 31/08/26 & 9/09/26  & 10 & 40 & 14   \\ \hline
16 & Informe ejecutivo para Finanzas                      & 10/09/26 & 17/09/26 & 8  & 30 & 15   \\ \hline
17 & Material y simulacro defensa p\'ublica             & 18/09/26 & 25/09/26 & 8  & 30 & 16   \\ \hline
\end{tabular}
\end{center}
...
\ganttbar[bar/.append style={fill=blue!65,
    label={[anchor=east,font=\footnotesize,text=black,xshift=-3pt]west:Feature engineering y selecci\'on de variables}}
]{10}{2026-07-10}{2026-07-21} \\
\ganttbar[bar/.append style={fill=blue!65,
    label={[anchor=east,font=\footnotesize,text=black,xshift=-3pt]west:Entrenamiento modelo base y enriquecido}}
]{11}{2026-07-22}{2026-07-31} \\
\ganttbar[bar/.append style={fill=blue!65,
    label={[anchor=east,font=\footnotesize,text=black,xshift=-3pt]west:C\'alculo PSI y feature importance}}
]{12}{2026-08-03}{2026-08-10} \\
\ganttbar[bar/.append style={fill=blue!65,
    label={[anchor=east,font=\footnotesize,text=black,xshift=-3pt]west:An\'alisis comparativo KS por deciles}}
]{13}{2026-08-11}{2026-08-20} \\
\ganttbar[bar/.append style={fill=blue!65,
    label={[anchor=east,font=\footnotesize,text=black,xshift=-3pt]west:Pipeline batch y estimaci\'on swap-in}}
]{14}{2026-08-21}{2026-08-28} \\
\ganttbar[bar/.append style={fill=red!55!black!60,
    label={[anchor=east,font=\footnotesize,text=black,xshift=-3pt]west:Redacci\'on memoria t\'ecnica}}
]{15}{2026-08-31}{2026-09-09} \\
\ganttbar[bar/.append style={fill=red!55!black!60,
    label={[anchor=east,font=\footnotesize,text=black,xshift=-3pt]west:Informe ejecutivo para Finanzas}}
]{16}{2026-09-10}{2026-09-17} \\
\ganttbar[bar/.append style={fill=red!55!black!60,
    label={[anchor=east,font=\footnotesize,text=black,xshift=-3pt]west:Material y simulacro defensa p\'ublica}}
...
\begin{itemize}
    ...
    \item \textbf{Probabilidad de ocurrencia (O): 3.} Si bien la literatura empírica respalda el valor predictivo de los burós privados, existe la posibilidad de que la información marginal aportada esté altamente correlacionada con los datos transaccionales del BCRA, y diluya así el salto de \textit{performance}.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Severidad (S): 7.} Un shock macroeconómico imprevisto agregaría una dificultad extra al desarrollo del modelo con los datos del buró, y puede distorsionar severamente las distribuciones de pago frente a la ventana histórica de entrenamiento.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Validación:} Revisión técnica junto al Orientador para certificar que el modelo posee la robustez poblacional necesaria para operar productivamente a lo largo del tiempo sin requerir reentrenamientos inmediatos.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Validación:} Certificación del \textit{dataset} de entrenamiento por parte del Oficial de Cumplimiento de la entidad, y comprobación de que la anonimización imposibilita la reidentificación de los individuos evaluados.
    \end{itemize}
    ...
    \begin{itemize}
        \item \textbf{Verificación:} Contabilización analítica de los registros retenidos tras ejecutar las operaciones de \textit{inner join} entre la base pública de la CENDEU y la base propietaria, y documentar la tasa de caída en las \textit{Jupyter Notebooks}.
        \item \textbf{Validación:} Aprobación metodológica por parte del Orientador y del Cliente, y confirmar que la pérdida de registros por disparidad de fuentes no introduce sesgos de selección que invaliden la muestra.
    \end{itemize}
    ...
    \begin{itemize}
        \item \textbf{Verificación:} Ejecución aislada del \textit{pipeline} de inferencia sobre un archivo de prueba (\textit{dummy data}), que mide el tiempo de procesamiento y consumo de memoria RAM al generar las puntuaciones.
    ...
    \begin{itemize}
        \item \textbf{Verificación:} Creación de un \textit{script} financiero que simule la aplicación de cortes de aprobación (\textit{cut-offs}) paralelos, y calcula el margen de ganancia teórica al utilizar la matriz de predicción enriquecida.
    ...
    \begin{itemize}
        ...
        \item \textbf{Validación:} Revisión de caja negra por parte del Orientador de los diagramas de distribución (\textit{KDE plots}), para aprobar que el tratamiento de asimetrías no altera la realidad financiera de los usuarios.
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \item \textbf{Validación:} Defensa exitosa y validación técnica final del documento frente al tribunal de jurados de la especialización, que certifica la idoneidad del trabajo como especialista en Inteligencia Artificial.
    \end{itemize}
